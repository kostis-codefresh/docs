...
* [pulumi plugin install]({{< relref "pulumi_plugin_install.md" >}})	 - Install one or more plugins
* [pulumi plugin ls]({{< relref "pulumi_plugin_ls.md" >}})	 - List plugins
* [pulumi plugin rm]({{< relref "pulumi_plugin_rm.md" >}})	 - Remove one or more plugins from the download cache
